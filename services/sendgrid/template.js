...
body {font-family: 'Muli', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">Mohon lakukan verifikasi email untuk dapat</span><span style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif"> membeli paket liburan kamu di <strong><span style="color:#1053b7;">Travel</span><span style="color:#eba41f;">10</span></strong>!</span><span style="font-size: 18px"></span></div><br/>
